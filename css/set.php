  ...
  <body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
            ...
            <div class="nav">
              ...
              <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="display.html">查看信息</a>
                    <a class="nav-link" href="404.html">分析信息</a>
                </nav>
            </div>
              <div
                class="collapse"
              ...
              <div class="collapse" id="collapsePages" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="set.php">设置</a>
                </nav>
            </div>
              <div
                class="collapse"
      ...
      <div id="layoutSidenav_content">
        <main background="assets\img\agriculture.jpg" >
          <div class="container-fluid px-4">       
                <h1 class="mt-4">智慧农业管理系统</h1>

                <h2 class="mt-4">智慧农业管理系统</h2>
        </main>
